...
<head>
  ...
  <link rel="stylesheet" href="{{asset ('public/css/admin_style1.css') }}">
  <!-- End Layout styles -->
...
<body>
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        ...
        <a class="navbar-brand brand-logo-mini" href="index.html">
          <img src="{{ asset('img/logo-mini.svg') }}" alt="logo" /> </a>
      </div>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0"
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                  <img src="{{ asset('img/faces/face10.jpg') }}" alt="image" class="img-sm profile-pic"> </div>
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                  <img src="{{ asset('img/faces/face12.jpg') }}" alt="image" class="img-sm profile-pic"> </div>
                <div class="preview-item-content flex-grow py-2">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                  <img src="{{ asset('img/faces/face1.jpg') }}" alt="image" class="img-sm profile-pic"> </div>
                <div class="preview-item-content flex-grow py-2">
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle" src="{{ asset('img/faces/face8.jpg') }}" alt="Profile image"> </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                <img class="img-md rounded-circle" src="{{ asset('img/faces/face8.jpg') }}" alt="Profile image">
          ...
          <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
              <div class="profile-image">
                <img class="img-xs rounded-circle" src="{{ asset('img/faces/face8.jpg') }}" alt="profile image">
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="d-flex mt-3 py-2 border-bottom">
                        <img class="img-sm rounded-circle" src="{{ asset('img/faces/face3.jpg') }}" alt="profile image">
                      ...
                      <div class="d-flex py-2 border-bottom">
                        <img class="img-sm rounded-circle" src="{{ asset('img/faces/face4.jpg') }}" alt="profile image">
                        <div class="wrapper ml-2">
  ...
  <!-- inject:js -->
  <script src="{{ asset('resources/js/shared/off-canvas.js') }}"></script>
  <script src="{{ asset('resources/js/shared/misc.js') }}"></script>
  <!-- endinject -->
  <!-- Custom js for this page-->
  <script src="{{ asset('resources/js/demo_1/dashboard.js') }}"></script>
